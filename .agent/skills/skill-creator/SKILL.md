...
description: Generates high-quality, predictable, and efficient .agent/skills/ directories based on user requirements. Use this skill whenever the user asks you to create, define, or build a new skill.
---
